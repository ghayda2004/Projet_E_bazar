  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              variant="outline"
              size="sm"
              className={`gap-2 transition-all duration-300 ${viewMode === 'grid' ? 'bg-slate-100' : ''
                }`}
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              className={`gap-2 transition-all duration-300 ${showFilters ? 'bg-blue-100 text-blue-700 border-blue-300' : ''
                }`}
            >
        ...
        <div className={`mb-6 transition-all duration-300 ${showFilters ? 'opacity-100 max-h-20' : 'opacity-0 max-h-0 overflow-hidden'
          }`}>
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className={`transition-all duration-300 ${sortBy === 'default'
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className={`transition-all duration-300 ${sortBy === 'price-asc'
                    ? 'bg-slate-700 text-white border-slate-700 scale-105'
                    : 'hover:scale-105'
                  }`}
              >
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className={`transition-all duration-300 ${sortBy === 'price-desc'
                    ? 'bg-slate-700 text-white border-slate-700 scale-105'
                    : 'hover:scale-105'
                  }`}
              >
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className={`transition-all duration-300 ${sortBy === 'rating'
                    ? 'bg-slate-700 text-white border-slate-700 scale-105'
                    : 'hover:scale-105'
                  }`}
              >
        ...
        {loading ? (
          ...
          <div className={`grid gap-6 transition-all duration-300 ${viewMode === 'grid'
            ...
            {displayProducts.map((product: any) => (
              <ProductCard
                ...
                seller={typeof product.seller === 'object' ? (product.seller?.storeName || product.seller?.name) : (product.seller || "API Store")}
