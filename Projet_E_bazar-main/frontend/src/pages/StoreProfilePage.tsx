...
export default function StoreProfilePage({
  ...
  const loadStoreData = async () => {
    ...
    try {
      ...
      const sellerResponse = await fetch(`http://localhost:5000/api/auth/sellers/${sellerId}`);
      ...
      const productsResponse = await fetch(`http://localhost:5000/api/products/seller/${sellerId}`);
